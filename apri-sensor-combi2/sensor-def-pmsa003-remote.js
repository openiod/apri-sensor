...
sensor	: {
  ...
  , sensorSystem: 'apri-sensor-pmsa003'
	...
	, addMeasurement: function(data) {
		...
		this.units[unitId].total.concPM1_0_CF1	+= parseFloat(data[1])/100;
		this.units[unitId].total.concPM2_5_CF1	+= parseFloat(data[2])/100;
		this.units[unitId].total.concPM10_0_CF1	+= parseFloat(data[3])/100;
    this.units[unitId].total.concPM1_0_amb	+= parseFloat(data[4])/100;
		this.units[unitId].total.concPM2_5_amb	+= parseFloat(data[5])/100;
		this.units[unitId].total.concPM10_0_amb	+= parseFloat(data[6])/100;
    this.units[unitId].total.rawGt0_3um	    += parseFloat(data[7])/100;
		this.units[unitId].total.rawGt0_5um	    += parseFloat(data[8])/100;
		this.units[unitId].total.rawGt1_0um	    += parseFloat(data[9])/100;
    this.units[unitId].total.rawGt2_5um	    += parseFloat(data[10])/100;
		this.units[unitId].total.rawGt5_0um	    += parseFloat(data[11])/100;
		this.units[unitId].total.rawGt10_0um	  += parseFloat(data[12])/100;
